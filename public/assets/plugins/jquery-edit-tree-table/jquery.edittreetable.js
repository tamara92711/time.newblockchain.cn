	...
	$.fn.bstreetable = function(options){
        ...
        element.delegate(".form-control","blur",function(){
            ...
            if(!data.id&&!curElement.attr("data-oldval")){
                ...
                var data = settings.nodeaddCallback(data,function(_data){
                    if(_data){
                ...
                curElement.parent().attr("data-id", data.id);
                curElement.parent().parent().attr("data-id",data.id);
                curElement.parent().parent().attr("data-innercode",data.innercode);
                curElement.attr("data-oldval",curElement.val());                      
            }
