...
use app\PlugInUnit\UnionPayB2c\sdk\AcpService;
use app\PlugInUnit\UnionPayB2c\sdk\SDKConfig;
...
class UnionPayB2c
{
    ...
    {
        $this->params[ 'orderId' ] = '1';//\str_replace( '-','',$info[ 'order_sn_id' ] );
        $this->params[ 'txnAmt' ]  = $info->amount;
